...
print(f"  A weight is 2 bytes (bf16). One multiply-add uses it: 2 FLOP.")
...
print(f"  real servers set max_num_seqs in the hundreds. You do not quite")
print(f"  reach it. KV cache traffic also grows with B, and PagedAttention")
print(f"  exists to relax that constraint.")
print(f"\n  A profiler shows you neither ratio. It shows achieved RATES")
print(f"  (GB/s, GFLOP/s). You compute these two numbers in advance, to")
print(f"  predict which of those rates reaches its limit.{X}")
